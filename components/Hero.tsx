      ...
      <div className="container mx-auto px-6 py-16 md:py-24">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className={`relative transition-all duration-700 ease-out delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'}`}>
            ...
            <img src="https://picsum.photos/id/1062/800/900" alt="Jovem estudante sorrindo" className="rounded-lg shadow-2xl w-full h-auto object-cover animate-pulse-slow" />
          </div>
        </div>
      </div>
    </section>
